...
getDistricts(){
  ...
  donor_click()
  {
	  if(this.grp==""||this.stat==""||this.dist==""||this.city==""||this.plasma==""||this.avail==""||this.email=="")
	  {
		...
		var donor =
		  {
		   ...
		   this.http.post('http://localhost:8080/Donor',donor,{responseType: 'text'}).subscribe(data => 
		  {
				alert(data)
